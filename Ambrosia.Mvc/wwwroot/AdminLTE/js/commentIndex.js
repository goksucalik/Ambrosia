                                ...
                                $.each(commentResult.Data.Comments.$values,
                                    function (index, comment) {
                                        ...
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            newComment.CreatedName,
                                            `${convertToShortDate(newComment.ModifiedDate)}`,
                                            newComment.ModifiedName,
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            dataTable.row(tableRow).data([
                                ...
                                commentUpdateAjaxModel.CommentDto.Comment.Product.Name,
                                ...
                                commentUpdateAjaxModel.CommentDto.Comment.CreatedName,
                                `${convertToShortDate(commentUpdateAjaxModel.CommentDto.Comment.ModifiedDate)}`,
                                commentUpdateAjaxModel.CommentDto.Comment.ModifiedName,
                        ...
                        success: function (data) {
                            ...
                            if (commentResult.Data) {
                                dataTable.row(tableRow).data([
                                    ...
                                    commentResult.Data.Comment.Product.Name,
                                    ...
                                    commentResult.Data.Comment.CreatedName,
                                    `${convertToShortDate(commentResult.Data.Comment.ModifiedDate)}`,
                                    commentResult.Data.Comment.ModifiedName,
