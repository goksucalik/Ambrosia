$(document).ready(function () {
    ...
    <tr name ="$${categoryAddAjaxModel.CategoryDto.Category.Id}">
        ...
        <td>${categoryAddAjaxModel.CategoryDto.Category.CreatedName}</td>
        <td>${convertToShortDate(categoryAddAjaxModel.CategoryDto.Category.ModifiedDate)}</td>
        <td>${categoryAddAjaxModel.CategoryDto.Category.ModifiedName}</td>
        <td>
            <button class="btn btn-primary btn-update btn-sm" data-id="${categoryAddAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-edit"></span></button>
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            dataTable.row.add([
                                ...
                                categoryAddAjaxModel.CategoryDto.Category.ModifiedName,
                                `<td>
    ...
    <tr name=$"${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
        ...
        <td>${categoryUpdateAjaxModel.CategoryDto.Category.CreatedName}</td>
        <td>${convertToShortDate(categoryUpdateAjaxModel.CategoryDto.Category.ModifiedDate)}</td>
        <td>${categoryUpdateAjaxModel.CategoryDto.Category.ModifiedName}</td>
        <td>
            <button class="btn btn-primary btn-update btn-sm" data-id="${categoryUpdateAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-edit"></span></button>
